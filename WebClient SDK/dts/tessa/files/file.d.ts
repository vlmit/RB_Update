...
export declare class TessaFile extends FileEntity implements IFile {
    constructor(id: guid, name: string, category: FileCategory | null, type: FileType, source: IFileSource, permissions: FilePermissionsSealed | null, modified?: string | null, modifiedById?: guid | null, modifiedByName?: string | null, isLocal?: boolean, origin?: IFile | null);
    private _name;
    private _category;
    private _type;
    private _origin;
