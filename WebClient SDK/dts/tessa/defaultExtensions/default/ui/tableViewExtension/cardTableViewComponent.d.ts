...
export declare class CardTableViewComponent extends ViewControlViewComponent {
    ...
    protected updateData(columns: ReadonlyMap<string, SchemeDbType>, rows: ReadonlyArray<ReadonlyMap<string, any>>, rowCount: number, selectionState?: ISelectionState | null): void;
}
