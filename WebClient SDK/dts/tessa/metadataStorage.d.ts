...
import { WorkplaceMetadataSealed, IWorkplaceComponentMetadata, WorkplaceMetadataComponentSealed } from 'tessa/views/workplaces';
...
export declare class MetadataStorage {
    ...
    deleteUserMetadata(metadata: IWorkplaceComponentMetadata | WorkplaceMetadataComponentSealed): Promise<ValidationResult | null>;
