...
export declare class LoginFormViewModel implements ILoginFormViewModel {
    ...
    localize(alias: string, defaultStr?: string): string;
    protected onLoginFieldChanged(_e: React.SyntheticEvent<HTMLInputElement>, validatedText: string): void;
    protected onPasswordFieldChanged(_e: React.SyntheticEvent<HTMLInputElement>, validatedText: string): void;
