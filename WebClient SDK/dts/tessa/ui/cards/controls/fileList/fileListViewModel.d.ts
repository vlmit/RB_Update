...
import { IFileControl, IFileControlManager } from 'tessa/ui/files/interfaces';
...
export declare type FileListCategoryFilter = (categories: (FileCategory | null)[]) => Promise<ReadonlyArray<FileCategory | null>>;
export declare type FileListTypeFilter = (category: FileCategory, types: FileType[]) => Promise<ReadonlyArray<FileType>>;
