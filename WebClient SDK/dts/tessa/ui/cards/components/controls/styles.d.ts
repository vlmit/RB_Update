...
export declare const StyledTextField: import("styled-components").StyledComponent<React.ForwardRefExoticComponent<Pick<TextFieldProps & StyledControlProps, React.ReactText> & React.RefAttributes<any>>, any, TextFieldProps & StyledControlProps, never>;
export declare const StyledRaisedButton: import("styled-components").StyledComponent<React.ForwardRefExoticComponent<Pick<RaisedButtonProps & StyledControlProps, React.ReactText> & React.RefAttributes<any>>, any, RaisedButtonProps & StyledControlProps, never>;
