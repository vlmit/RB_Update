...
export declare function navigateToCompletionOption(completionOption: CardTypeCompletionOptionSealed, navigator: TaskNavigator): void;
export declare function navigateToReturnFromPostponedState(navigator: TaskNavigator): void;
export declare function navigateToLockedForAuthorState(navigator: TaskNavigator): void;
...
export declare function createCompleteAction(completionOption: CardTypeCompletionOptionSealed, navigator: TaskNavigator, groupingType?: TaskGroupingType): TaskAction;
export declare function createReturnFromPostponedAction(navigator: TaskNavigator): TaskAction;
export declare function createUnlockForAuthorAction(navigator: TaskNavigator): TaskAction;
export declare function createProgressAction(navigator: TaskNavigator): TaskAction;
export declare function createNavigateBackAction(navigator: TaskNavigator): TaskAction;
export declare function createLockForAuthorAction(navigator: TaskNavigator): TaskAction;
