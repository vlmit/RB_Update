...
import { ViewMetadataSealed, ViewSelectionMode } from 'tessa/views/metadata';
...
export interface IViewComponentBase extends IParametersSetNameProvider {
    ...
    onFilterDialogInitialized?: (vm: FilterDialogViewModel) => Promise<void>;
}
