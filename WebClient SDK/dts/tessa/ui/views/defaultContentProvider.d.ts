...
export declare class DefaultContentProvider implements IContentProvider<WorkplaceLayoutViewModel | null> {
    constructor(workplace: IWorkplaceViewModel, metadata: DataNodeMetadataSealed, parameters: IViewParameters | null | undefined, parametersFactory: (p: ViewParameterMetadataSealed[]) => IViewParameters, doubleClickAction?: DoubleClickAction | null, refSection?: string, selectAction?: SelectAction | null, sortingColumns?: Map<guid, SortingColumn[]> | null, isCloneCreation?: boolean);
    private _workplace;
    private _metadata;
