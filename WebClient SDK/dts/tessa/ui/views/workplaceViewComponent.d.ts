...
export interface DataColumnConverterDelegate {
    (model: IWorkplaceViewComponent, columnName: string, columnDataType: SchemeDbType): [string, SchemeDbType];
}
export interface DataColumnsConverterDelegate {
    (model: IWorkplaceViewComponent, columnNames: string[], columnDataTypes: SchemeType[]): [string, SchemeDbType][];
}
