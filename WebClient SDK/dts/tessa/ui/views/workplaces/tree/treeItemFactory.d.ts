...
export declare abstract class TreeItemAsyncLoader<T extends ITreeItem, R> implements ITreeItemAsyncLoader {
    ...
    protected abstract loadDataInUI(treeItem: T, data: R): any;
...
export declare class ViewTreeItemAsyncLoader extends TreeItemAsyncLoader<IViewTreeItem, [WorkplaceViewSubsetMetadataSealed[], WorkplaceMetadataComponentSealed[]]> {
...
export declare class SearchQueryTreeItemAsyncLoader extends TreeItemAsyncLoader<ISearchQueryTreeItem, [WorkplaceViewSubsetMetadataSealed[], WorkplaceMetadataComponentSealed[]]> {
...
export declare abstract class AbstractSubsetFamilyTreeItemAsyncLoader<T extends ITreeItem, R> extends TreeItemAsyncLoader<T, R> {
    protected static addOrReplaceSubsetRefParam(parameters: IViewParameters, viewMetadata: ViewMetadataSealed, refParam: string, caption: string, value: any): void;
