...
export declare function showViewsDialog(refSection: string, onValueSelected: (value: SelectedValue) => Promise<void>, parameters?: RequestParameter[] | null, selectAction?: SelectAction | null): Promise<void>;
