...
import { IStorage, MapStorage, IStorageValueFactory } from 'tessa/platform/storage';
...
export declare class CardTask extends CardInfoStorageObject implements ICloneable<CardTask> {
    ...
    static readonly authorPositionKey: string;
    ...
    get authorPosition(): string | null;
    set authorPosition(value: string | null);
    get action(): number;
    ...
    get isPerformerDeputy(): boolean;
    get isAuthor(): boolean;
    get isAuthorDeputy(): boolean;
    get isHiddenFromAuthor(): boolean;
    set isHiddenFromAuthor(value: boolean);
