...
export declare type TypeSettings = {
    [key: string]: null | boolean | number | string | Array<TypeSettings> | TypeSettings;
};
export declare type TypeSettingsSealed = {
    readonly [key: string]: null | boolean | number | string | ReadonlyArray<TypeSettings> | TypeSettings;
};
