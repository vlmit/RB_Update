export declare enum SchemeDbType {
    /**
    ...
    Boolean = 3,
    /**
     * A currency value ranging from -2 63 (or -922,337,203,685,477.5808)
     * to 2 63 -1 (or +922,337,203,685,477.5807) with an accuracy to
     * a ten-thousandth of a currency unit.
     */
    Currency = 4,
    /**
     ...
     * approximately 5.0 x 10 -324 to 1.7 x 10 308 with a precision of
     * 15-16 digits.
     */
    Double = 8,
    /**
    ...
    Int64 = 12,
    /**
     * A general type representing any reference or value type not explicitly
     * represented by another DbType value.
     */
    Object = 13,
    /**
    ...
    String = 16,
    /**
     * A type representing a SQL Server DateTime value. If you want to use a
     * SQL Server time value, use System.Data.SqlDbType.Time.
     */
    Time = 17,
    /**
    ...
    Xml = 25,
    /**
     * Date and time data. Date value range is from January 1,1 AD
     * through December 31, 9999 AD. Time value range is 00:00:00 through
