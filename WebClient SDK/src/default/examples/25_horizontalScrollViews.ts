...
/**
 * Данное расширение применимо для всех представлений. Позволяет активировать горизонтальный скролл
 * вместо добавления overflow-строк при уменьшении ширины представления.
 */
const initializeContentBase =
  WorkplaceViewComponentInitializationStrategy.prototype.initializeContent;
WorkplaceViewComponentInitializationStrategy.prototype.initializeContent = function initializeContent(
  component: IWorkplaceViewComponent,
  metadata: DataNodeMetadataSealed
) {
