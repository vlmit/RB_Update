...
/**
 * Скрывать/показывать какой-либо элемент управления задания в зависимости
 * от данных задания для определенного типа карточки.
 *
...
export class HideTaskBlockUIExtension extends CardUIExtension {
  ...
  private static modifyWorkspace(section: CardSection, task: TaskViewModel): void {
    if (
