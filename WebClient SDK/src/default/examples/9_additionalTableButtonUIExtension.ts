 ...
 * Для карточки типа "Автомобиль" добавляет дополнительную кнопку справа под контролом "Список Акций".
 * При нажатии на кнопку происходит получение данных из выделенной строки и, после, добавляется новая строка
 * в секцию с полученными данными (создается копия выделенной строки). При клике на контрол "Марка автомобиля"
 * и последующем нажатии на клавишу [Enter] фокус перемещается на контрол "Имя водителя".
 */
