 ...
 * - Если поле "Цвет" пустое, то блок "Дополнительная информация" скрывается,
 *   контрол "Марка автомобиля" становится видимым, а контрол "Пробег" становится редактируемым.
 */
