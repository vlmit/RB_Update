 ...
 * При клике на кнопку "Показать диалог" в карточке "Автомобиль" показываем кастомный диалог,
 * содержащий текстовое поле, а также кнопки "ОК" и "Закрыть". При нажатии на кнопку "OK" в консоли
 * отображается содержимое текстового поля.
 */
export class ShowCustomDialogUIExtension extends CardUIExtension {
  ...
  private static async showCustomDialog(): Promise<void> {
