...
namespace Tessa.Extensions.Default.Shared.Cards
{
    ...
    /// </summary>
    [Serializable]
    public sealed class CardViewControlInfo :
        CardStorageObject,
        ICloneable
    {
        #region Constructors
        ...
        /// <summary>
        /// Создаёт информацию о переходе к карточке из контрола представления на основании сериализованных данных.
        /// </summary>
        /// <param name="info">Информация о сериализованых данных.</param>
        /// <param name="context">Потоковый контекст.</param>
        private CardViewControlInfo(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
