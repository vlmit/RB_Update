...
namespace Tessa.Extensions.Default.Shared.Workflow.KrProcess
{
        ...
        CardTypeMetadataExtension
    {
            ...
            PrepareSourceCardType(CardType cardType, ICardMetadataExtensionContext context)
        {
            ...
            // при добавлении у форм меняется Order, поэтому можем сделать глобальными их блоки.
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            // новая логика. Теперь мы используем глобальные объекты.
            targetCardType.Validators.AddRange(krCardType.Validators);
            targetCardType.Extensions.AddRange(krCardType.Extensions);
            // меняем контент форм на глобальный.
            krCardTypeClone.Forms.ReplaceBlocks(krCardType.Forms);
            // далее старая логика.
