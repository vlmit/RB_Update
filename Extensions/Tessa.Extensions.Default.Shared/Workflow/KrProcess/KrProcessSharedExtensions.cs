...
namespace Tessa.Extensions.Default.Shared.Workflow.KrProcess
{
    ...
    public static class KrProcessSharedExtensions
    {
        ...
        public static bool TryGetStagesSection(this Card card, out CardSection section, bool preferVirtual = false)
        {
            ...
            return sections.TryGetValue(GetStagesAlias(card, preferVirtual), out section);
        }
        ...
        /// <summary>
        /// Задаёт новое значение полю <paramref name="key"/> в контейнере полей секции <paramref name="aci"/>, если оно было изменено.
        /// </summary>
        /// <typeparam name="T">Тип значения.</typeparam>
        /// <param name="aci">Объект, являющийся контейнером для полей карточки.</param>
        /// <param name="key">Имя поля.</param>
        /// <param name="value">Новое значение.</param>
        /// <returns>Значение <see langword="true"/>, если новое значение было записано в поле, иначе - <see langword="false"/>.</returns>
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            if (record?[Name] is not string name)
            {
