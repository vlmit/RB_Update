...
namespace Tessa.Extensions.Default.Shared.Workflow.KrPermissions
{
    ...
    public class KrPermissionFlagDescriptor : IEquatable<KrPermissionFlagDescriptor>
    {
        ...
        /// <param name="description">Заголовок флага. Выводится в ообщениях о правах на карточку или когда недостаточно прав</param>
        ...
        /// <summary>
        /// Объект, содержащий информацию о текущем флаге настроек прав доступа, не харящийся в базе данных и не имеющий контрола в карточке прав доступа.
        /// </summary>
        /// <param name="id">Идентификатор флага</param>
        /// <param name="name">Имя флага</param>
        /// <param name="includedPermissions">Список флагов, которые включены в данный флаг</param>
        ...
        /// </summary>
        public bool IsVirtual => SqlName == null;
