...
namespace Tessa.Extensions.Default.Chronos.FileConverters
{
        ...
        Plugin
    {
                    ...
                    else
                    {
                        ...
                        try
                        {
                            ...
                            if (performed)
                            {
                                ...
                                IUnityContainer container = await CreateUnityContainer();
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            return this.dependencies.OperationRepository.CompleteAsync(operationID, response, cancellationToken);
        }
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            await this.dependencies.OperationRepository.CompleteAsync(operationID, response, cancellationToken);
        }
        ...
        private async Task DeleteOperationSafeAsync(Guid operationID, CancellationToken cancellationToken = default)
        {
            try
            {
                await this.dependencies.OperationRepository.DeleteAsync(operationID, cancellationToken);
            }
            catch (OperationCanceledException)
            {
                throw;
        ...
        private static async Task<IUnityContainer> CreateUnityContainer()
        {
        ...
        public override async Task EntryPointAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                this.container = await CreateUnityContainer();
