...
namespace Tessa.Extensions.Chronos.Plugins
{
    ...
    public sealed class RBSED_ProcessDataFromEOS4SP :
        Plugin
    {
        #region Constants
        ...
        /// </summary>
        private const string ConfigFilePath = "configuration/RBSED_ProcessDataFromEOS4SP.xml";
        ...
        {
            logger.Info("Starting plugin RBSED_ProcessDataFromEOS4SP");
            ...
            logger.Info("Shutting down RBSED_ProcessDataFromEOS4SP");
        }
