...
namespace Tessa.Extensions.Chronos.Plugins
{
        ...
        Plugin
    {
        ...
        /// </summary>
        private const string ConfigFilePath = "configuration/RBOG_ProcessDataCategories.xml";
        ...
        {
            logger.Info("Starting plugin RBOG_ProcessDataCategories");
