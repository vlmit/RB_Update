...
namespace Tessa.Extensions.Default.Console.ExportLocalization
{
    ...
    {
        [Verb("ExportLocalization")]
        [LocalizableDescription("Common_CLI_ExportLocalization")]
        public static async Task ExportLocalization(
            [Output] TextWriter stdOut,
            [Error] TextWriter stdErr,
            [Argument] [LocalizableDescription("Common_CLI_LocalizationLibraryNames")] IEnumerable<string> name = null,
