...
namespace Tessa.Extensions.Default.Console.ImportTypes
{
    ...
    {
        [Verb("ImportTypes")]
        [LocalizableDescription("Common_CLI_ImportTypes")]
        public static async Task ImportTypes(
            [Output] TextWriter stdOut,
            [Error] TextWriter stdErr,
            [Argument] [LocalizableDescription("Common_CLI_SourceTypes")] string source,
            ...
            [Argument("c")] [LocalizableDescription("Common_CLI_RemoveExistentTypes")] bool clearTypes = false,
