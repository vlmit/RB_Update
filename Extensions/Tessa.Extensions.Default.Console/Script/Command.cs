...
namespace Tessa.Extensions.Default.Console.Script
{
    public static class Command
    {
            ...
            [Argument("nologo")] [LocalizableDescription("CLI_NoLogo")] bool nologo = false)
        {
            ...
            {
                string[] allScripts = ConsoleScriptHelper.FindAndGetScripts(null, null, out _).Keys.OrderBy(x => x).ToArray();
            ...
            Dictionary<string, Func<IConsoleScript>> actualScripts = ConsoleScriptHelper.FindAndGetScripts(scripts, null, out _);
