...
namespace Tessa.Extensions.Default.Console.Scripts
{
        ...
        ServerConsoleScriptBase
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            while (await reader.ReadAsync(cancellationToken))
            {
                ...
                try
                {
                    ...
                    var jsonString = jsonSettings.ToJsonString();
                ...
                {
                    await this.Logger.ErrorAsync($"Error while converting workplace settings ID={id:D}. Settings:{Environment.NewLine}{settings}");
                    throw;
                }
            }
        }
        ...
        protected override async ValueTask ShowHelpCoreAsync(CancellationToken cancellationToken)
        {
            ...
            await this.Logger.WriteLineAsync("-pp:from=_PersonalRoleSatellite - Specifies table with apropriate workplace settings metadata in exchange format." +
