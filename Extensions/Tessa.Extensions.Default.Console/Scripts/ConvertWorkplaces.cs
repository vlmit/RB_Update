...
namespace Tessa.Extensions.Default.Console.Scripts
{
        ...
        ServerConsoleScriptBase
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            while (await reader.ReadAsync(cancellationToken))
            {
                ...
                try
                {
                    ...
                    var typedJson = jsonMetadata.ToJsonString();
                ...
                {
                    await this.Logger.ErrorAsync($"Error while converting workplace ID={id:D}. Metadata:{Environment.NewLine}{metadata}");
                    throw;
                }
            }
        }
        ...
        protected override async ValueTask ShowHelpCoreAsync(CancellationToken cancellationToken)
        {
            ...
            await this.Logger.WriteLineAsync("-pp:from=_Workplaces - Specifies table with apropriate workplace metadata in exchange format. \"MetadataLegacy\" column is used.");
