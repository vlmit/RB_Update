...
namespace Tessa.Extensions.Default.Console.Scripts
{
        ...
        ServerConsoleScriptBase
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            while (await reader.ReadAsync(cancellationToken))
            {
                ...
                try
                {
                    ...
                    cardType.DeserializeFromXml(metadata);

                    string json = cardType.SerializeToJson();
        ...
        protected override async ValueTask ShowHelpCoreAsync(CancellationToken cancellationToken)
        {
            ...
            await this.Logger.WriteLineAsync("-pp:from=_Types - Specifies table with apropriate types metadata in xml format. \"Definition\" column is used.");
