...
namespace Tessa.Extensions.Default.Server.Workflow.KrObjectModel
{
        ...
        ISealable
    {
        ...
        /// <summary>
        /// Возвращает срок в квантах, если нет даты окончания задания <see cref="Planned"/>.
        /// </summary>
        [JsonIgnore]
        public int? PlannedQuants =>
            !this.Planned.HasValue
        ...
        private void FillStageProperties(CardRow stageRow)
        {
            ...
            this.StageGroupID = stageRow.Fields.Get<Guid>(KrConstants.StageGroupID);
            this.StageGroupName = stageRow.Fields.Get<string>(KrConstants.StageGroupName);
            this.StageGroupOrder = stageRow.Fields.Get<int>(KrConstants.StageGroupOrder);
            this.Name = stageRow.Fields.Get<string>(KrConstants.Name);
