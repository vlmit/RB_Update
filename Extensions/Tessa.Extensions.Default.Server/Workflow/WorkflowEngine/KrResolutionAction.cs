                ...
                await db
                    .SetCommand(
                        context.DbScope.BuilderFactory
                            ...
                            .C("ProcessName").Assign().P("ProcessName")
                            .C("ProcessKind").Assign().P("ProcessKind")
                            .Where().C("RowID").Equals().P("RowID")
                            .Build(),
                        db.Parameter("RowID", taskRowID),
                        db.Parameter("ProcessID", context.ProcessInstance.ID),
                        db.Parameter("ProcessName", context.ProcessInstance.Name),
                        db.Parameter("ProcessKind", WorkflowEngineHelper.WorkflowEngineProcessName))
                    .LogCommand()
