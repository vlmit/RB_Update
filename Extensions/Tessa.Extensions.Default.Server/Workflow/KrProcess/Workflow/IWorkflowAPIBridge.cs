...
namespace Tessa.Extensions.Default.Server.Workflow.KrProcess.Workflow
{
    public interface IWorkflowAPIBridge
    {
        ...
        Task AddActiveTaskAsync(Guid taskID, CancellationToken cancellationToken = default);
        ...
        /// <summary>
        /// Удяляет задание с указанным идентификатором из списка активных.
        /// В случае неудачи будет выброшено исключение
        /// </summary>
        /// <param name="taskID">Идентификатор задания.</param>
        /// <param name="cancellationToken">Объект, посредством которого можно отменить выполнения асинхронной задачи.</param>
        /// <returns>Асинхронная задача.</returns>
        ValueTask RemoveActiveTaskAsync(Guid taskID, CancellationToken cancellationToken = default);

        /// <summary>
        /// Возвращает список идентификаторов активных заданий.
        /// </summary>
        /// <param name="cancellationToken">Объект, посредством которого можно отменить выполнения асинхронной задачи.</param>
        /// <returns>Cписок идентификаторов активных заданий.</returns>
        ValueTask<IReadOnlyList<Guid>> GetActiveTasksAsync(CancellationToken cancellationToken = default);
        ...
        Task<WorkflowCounterState> DecrementCounterAsync(
            int counterNumber,
