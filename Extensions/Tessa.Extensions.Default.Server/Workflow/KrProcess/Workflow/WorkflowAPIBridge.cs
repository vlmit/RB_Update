...
namespace Tessa.Extensions.Default.Server.Workflow.KrProcess.Workflow
{
    public sealed class WorkflowAPIBridge : IWorkflowAPIBridge
    {
        ...
        {
            CardTask task = await this.AddNewTaskAsync(taskTypeID, roleID, roleName, taskRowID: taskRowID, cancellationToken: cancellationToken);
        ...
        public ValueTask<bool> TryRemoveActiveTaskAsync(
            ...
            CancellationToken cancellationToken = default)
        {
            return this.RemoveActiveTaskInternalAsync(taskID, false, cancellationToken);
        }
        ...
        /// <inheritdoc />
        public Task InitCounterAsync(int counterNumber, int initialValue, CancellationToken cancellationToken = default) =>
            this.manager.InitCounterAsync(counterNumber, this.processInfo, initialValue, cancellationToken);

        /// <inheritdoc />
        public Task<WorkflowCounterState> DecrementCounterAsync(int counterNumber, int decrementValue = 1, CancellationToken cancellationToken = default) =>
            this.manager.DecrementCounterAsync(counterNumber, this.processInfo, decrementValue, cancellationToken);

        /// <inheritdoc />
        public Task<bool> RemoveCounterAsync(int counterNumber, CancellationToken cancellationToken = default) =>
