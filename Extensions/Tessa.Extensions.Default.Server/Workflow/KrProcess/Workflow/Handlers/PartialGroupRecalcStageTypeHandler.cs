...
namespace Tessa.Extensions.Default.Server.Workflow.KrProcess.Workflow.Handlers
{
    ...
    public class PartialGroupRecalcStageTypeHandler : StageTypeHandlerBase
    {
        ...
        /// <param name="krCompilationCache"><inheritdoc cref="IKrCompilationCache" path="/summary"/></param>
            ...
            IKrCompilationCache krCompilationCache)
        {
            ...
            this.KrCompilationCache = krCompilationCache ?? throw new ArgumentNullException(nameof(executorFunc));
        }
        ...
        protected IKrCompilationCache KrCompilationCache { get; set; }
