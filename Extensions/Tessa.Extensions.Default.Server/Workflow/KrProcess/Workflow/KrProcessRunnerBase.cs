...
namespace Tessa.Extensions.Default.Server.Workflow.KrProcess.Workflow
{
    ...
    public abstract class KrProcessRunnerBase : IKrProcessRunner
    {
        ...
        private readonly ICardStreamServerRepository cardStreamServerRepositoryExt;
        ...
        protected KrProcessRunnerBase(
            ...
            ICardRepository cardRepositoryExt,
            ICardRepository cardRepositoryEwt,
            ICardStreamServerRepository cardStreamServerRepositoryExt,
            ICardStreamServerRepository cardStreamServerRepositoryEwt)
        {
            ...
            this.ExecutorFunc = executorFunc ?? throw new ArgumentNullException(nameof(executorFunc));
            ...
            this.RunnerProvider = runnerProvider ?? throw new ArgumentNullException(nameof(runnerProvider));
            ...
            this.Interrupter = interrupter ?? throw new ArgumentNullException(nameof(interrupter));
            ...
            this.cardRepositoryExt = cardRepositoryExt ?? throw new ArgumentNullException(nameof(cardRepositoryExt));
            this.cardRepositoryEwt = cardRepositoryEwt ?? throw new ArgumentNullException(nameof(cardRepositoryEwt));
            this.cardStreamServerRepositoryExt = cardStreamServerRepositoryExt ?? throw new ArgumentNullException(nameof(cardStreamServerRepositoryExt));
            this.cardStreamServerRepositoryEwt = cardStreamServerRepositoryEwt ?? throw new ArgumentNullException(nameof(cardStreamServerRepositoryEwt));
        }
            ...
            IKrProcessRunnerContext context)
        {
            ...
            else
            {
                ...
                instance = await KrProcessHelper.CreateScriptInstanceAsync(
            ...
            IKrProcessRunnerContext context)
        {
            ...
            var ctx = new KrExecutionContext(
                ...
                krCompilationCache: this.CompilationCache,
        ...
        {
            ICardRepository cardRepositorySuitable;
            ICardStreamServerRepository cardStreamServerRepositorySuitable;

            if (KrProcessHelper.IsTransactionOpened(this.DbScope))
            {
                cardRepositorySuitable = this.cardRepositoryEwt;
                cardStreamServerRepositorySuitable = this.cardStreamServerRepositoryEwt;
            }
            else
            {
                cardRepositorySuitable = this.cardRepositoryExt;
                cardStreamServerRepositorySuitable = this.cardStreamServerRepositoryExt;
            }
            ...
            var digest = await cardRepositorySuitable.GetDigestAsync(
                card,
            ...
            var response = await CardHelper.StoreAsync(
                ...
                cardRepositorySuitable,
                cardStreamServerRepositorySuitable,
                cancellationToken);
