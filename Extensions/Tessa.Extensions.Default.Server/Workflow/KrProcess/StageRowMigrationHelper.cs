    ...
    public static class StageRowMigrationHelper
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            foreach (var stageRow in source.GetStagesSection().Rows)
            {
                ...
                orders[newRowIDStr] = Int32Boxes.Box(stageRow.TryGet<int>(KrConstants.Order));
            }
            ...
            ISignatureProvider signatureProvider)
        {
            ...
            if (orders is null
                ...
                && row.TryGet<int?>(KrConstants.Order) != (int) currentOrderObj)
            {
                orderChanged = true;
            }
        }
            ...
            Card card)
        {
            ...
            {
                row[KrConstants.KrStages.StageStateID] = stageStateIDObj;
                row[KrConstants.KrStages.StageStateName] = stageStateName;
            }
