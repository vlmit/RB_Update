...
namespace Tessa.Extensions.Default.Client.UI
{
    ...
    public sealed class TabContentIndicator
        : ControlContentIndicator<IFormViewModel>
    {
        #region Constructors
        ...
        /// <inheritdoc/>
        protected override string GetDisplayName(IFormViewModel control)
        {
            return control.TabCaption;
        }

        /// <inheritdoc/>
        protected override void SetDisplayName(IFormViewModel control, string name)
        {
            control.TabCaption = name;
        }

        /// <inheritdoc/>
        protected override void VisitControl(Visitor visitor, IFormViewModel control)
        {
