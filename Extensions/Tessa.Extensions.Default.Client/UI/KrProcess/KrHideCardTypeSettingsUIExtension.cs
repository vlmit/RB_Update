...
namespace Tessa.Extensions.Default.Client.UI.KrProcess
{
    public sealed class KrHideCardTypeSettingsUIExtension : CardUIExtension
    {
        public override async Task Initialized(ICardUIExtensionContext context)
        {
            ...
            if (!(model.MainForm is DefaultFormMainViewModel))
            {
                return;
            }
            ...
            {
                IBlockViewModel cardTypesBlock
                    = model.MainForm.Blocks.FirstOrDefault(x => x.Name == KrTypesUIHelper.TypesBlock);
            ...
            else if (model.CardType.ID == DefaultCardTypes.KrDocTypeTypeID)
            {
                ...
                context.Model.MainForm.RearrangeSelf();
            }
        }
        ...
        private static void CollapseIfDocTypesUnused(GridRowEventArgs e)
        {
            ...
            if (useControl != null)
            {
                ...
                e.RowModel.MainForm.RearrangeSelf();
        ...
        {
            foreach (var block in e.RowModel.MainForm.Blocks)
            {
