...
namespace Tessa.Extensions.Default.Client.UI.KrProcess.StageHandlers
{
        ...
        IKrStageTypeUIHandlerContext
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            this.RowModel = rowModel ?? throw new ArgumentNullException(nameof(rowModel));
        ...
        /// <inheritdoc />
        public IReadOnlyList<IFormViewModel> SettingsForms { get; }

        #endregion

        #region Private Methods

        private static IReadOnlyList<IFormViewModel> GetSettingsForms(
            ICardModel rowModel,
            Guid stageTypeID)
        {
            var settingsForms = new List<IFormViewModel>();
