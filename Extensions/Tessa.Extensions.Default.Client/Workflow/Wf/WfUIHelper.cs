...
namespace Tessa.Extensions.Default.Client.Workflow.Wf
{
    ...
    public static class WfUIHelper
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            {
                throw new ArgumentNullException("rootResolution");
            }
            ...
            await VisualizeResolutionsCoreAsync(generator, nodeLayout, nodeFactory, card, rootHistoryItem, rootResolution, extensionContainer, cancellationToken);
            return true;
        }
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            if (rootHistoryItem == null)
            {
                throw new ArgumentNullException("rootHistoryItem");
            }
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            return visitor.VisitAsync(generator, rootHistoryItem, rootResolution, cancellationToken);
        }
