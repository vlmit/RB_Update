...
namespace Tessa.Extensions.Default.Client.Workflow.KrProcess.CommandInterpreter
{
    ...
    public abstract class AdvancedDialogCommandHandler : ClientCommandHandlerBase
    {
        ...
        {
            Check.ArgumentNotNull(createAdvancedCardDialogManagerFunc, nameof(createAdvancedCardDialogManagerFunc));
            Check.ArgumentNotNull(session, nameof(session));
            Check.ArgumentNotNull(cardMetadata, nameof(cardMetadata));

            this.createAdvancedCardDialogManagerFunc = createAdvancedCardDialogManagerFunc;
