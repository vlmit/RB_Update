...
namespace Tessa.Extensions.Default.Client.Views
{
    ...
    public sealed class ParameterMapping
    {
        ...
        {
            Check.ArgumentNotNullOrEmpty(alias, nameof(alias));
            Check.ArgumentNotNullOrEmpty(valueSectionName, nameof(valueSectionName));
            Check.ArgumentNotNullOrEmpty(valueFieldName, nameof(valueFieldName));

            this.Alias = alias;
            this.ValueSectionName = valueSectionName;
