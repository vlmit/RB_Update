...
namespace Tessa.Extensions.Default.Client.Views
{
        ...
        IAdvancedFilterViewDialogManager
    {
        ...
        {
            Check.ArgumentNotNull(createDialogFormFuncAsync, nameof(createDialogFormFuncAsync));
            Check.ArgumentNotNull(advancedCardDialogManager, nameof(advancedCardDialogManager));
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            Check.ArgumentNotNull(parameters, nameof(parameters));
