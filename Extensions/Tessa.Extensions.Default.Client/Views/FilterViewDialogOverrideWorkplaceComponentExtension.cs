...
namespace Tessa.Extensions.Default.Client.Views
{
        ...
        IWorkplaceViewComponentExtension
    {
            ...
            IFilterViewDialogDescriptorRegistry filterViewDialogDescriptorRegistry)
        {
            ...
            Check.ArgumentNotNull(advancedFilterViewDialogManager, nameof(advancedFilterViewDialogManager));
            Check.ArgumentNotNull(filterViewDialogDescriptorRegistry, nameof(filterViewDialogDescriptorRegistry));

            this.session = session;
            this.advancedFilterViewDialogManager = advancedFilterViewDialogManager;
            this.filterViewDialogDescriptorRegistry = filterViewDialogDescriptorRegistry;
        }
