...
namespace Tessa.Test.Default.Shared
{
    ...
    public static class TestSettings
    {
        ...
        /// очищались бы соответствующие папки.<para/>
        /// Значение по умолчанию: <see langword="false"/>.
        /// </remarks>
        public static bool UseSimpleNamingScheme { get; } = ConfigurationManager.Settings.TryGet<bool>("FileUseSimpleNamingScheme");
