...
namespace Tessa.Test.Default.Shared.Views
{
    ...
    public static class UserExtensionTestHelper
    {
        ...
        private sealed class TestViewService : IViewService
        {
            ...
            /// <summary>
            /// Возвращает список представлений в метаданных которых имеются ссылки <see cref="IViewReferenceMetadata"/>
            /// с псевдонимом <paramref name="referenceName"/>
            /// </summary>
            ...
            /// Список представлений
            /// </returns>
            public ValueTask<IReadOnlyList<ITessaView>> GetByReferencesAsync(string referenceName, CancellationToken cancellationToken = default) =>
                throw new NotSupportedException();
