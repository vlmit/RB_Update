...
namespace Tessa.Test.Default.Shared
{
        ...
        IApplyToTest
    {
        ...
        public void ApplyToTest(NUnit.Framework.Internal.Test test)
        {
            ...
            IPropertyBag properties = test.Properties;
        ...
        {
            if (!(properties.Get(DatabasePropertyNames.ProviderName) is string factorName))
            {
                return false;
            }
            ...
            try
            {
                DbProviderFactory factory = ConfigurationManager
                    .GetConfigurationDataProviderFromType(factorName)
