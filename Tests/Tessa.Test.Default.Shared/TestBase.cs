...
namespace Tessa.Test.Default.Shared
{
        ...
        ITestBase
    {
        ...
        protected TestBase()
        {
            ...
            this.GetTestActions(ActionStage.AfterInitializeContainer).Add(
                new TestAction(
                    ...
                    static sender =>
                    {
                        ((IUnityContainerHolder) sender).UnityContainer.RegisterExternalObjectHandlersInRegistry();
        ...
        /// <inheritdoc/>
        public ITestCardManager TestCardManagerOnce => this.UnityContainer.Resolve<ITestCardManager>(TestCardManagerNames.Once);
        ...
        /// <inheritdoc/>
        public virtual IRoleRepository RoleRepository => this.UnityContainer.TryResolve<IRoleRepository>();
        ...
        /// <inheritdoc/>
        public async ValueTask<string> GetNextRandomFixtureNameAsync(
            CancellationToken cancellationToken = default)
        {
            var testType = TestExecutionContext.CurrentContext.CurrentTest.TypeInfo.Type;
            return await this.NameResolver.GetFixtureNameAsync(testType, cancellationToken);
        }
