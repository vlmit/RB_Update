...
namespace Tessa.Test.Default.Shared
{
        ...
        IDisposable
    {
        ...
        private static readonly Action<Exception> recordTearDownExceptionAction =
            TestExecutionContext.CurrentContext.CurrentResult.RecordTearDownException;
        ...
        {
            Check.ArgumentNotNull(testFixture, nameof(testFixture));
        ...
        private async Task InitializeSequenceAsync()
        {
            using (await this.asyncLock.EnterAsync())
            {
                ...
                try
                {
                    ...
                    await TestHelper.InitializeDefaultLocalizationAsync();
