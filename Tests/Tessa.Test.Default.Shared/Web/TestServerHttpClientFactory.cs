...
namespace Tessa.Test.Default.Shared.Web
{
        ...
        IHttpClientFactory
    {
        ...
        /// </summary>
        /// <param name="webApplicationFactory">Класс предоставляющий методы для создания тестового сервера предназначенного для тестирования web-приложений.</param>
        public TestServerHttpClientFactory(
            IWebApplicationFactory webApplicationFactory)
        {
