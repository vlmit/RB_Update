...
namespace Tessa.Test.Default.Shared
{
        ...
        where T : class, ITestBase
    {
        ...
        protected TestBaseWrapper(
            T internalTestBase)
        {
            Check.ArgumentNotNull(internalTestBase, nameof(internalTestBase));

            this.InternalTestBase = internalTestBase;
        ...
        /// <inheritdoc/>
        public virtual IRoleRepository RoleRepository => this.InternalTestBase.RoleRepository;
