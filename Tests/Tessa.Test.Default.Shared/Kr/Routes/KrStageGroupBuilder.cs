...
namespace Tessa.Test.Default.Shared.Kr.Routes
{
        ...
        INamedObject
    {
        ...
        public KrStageGroupBuilder SetName(string value) =>
            this.SetField(KrConstants.Name, value);
        ...
        public string GetName() =>
            this.TryGetField<string>(KrConstants.Name);
        ...
        public KrStageGroupBuilder SetOrder(int value) =>
            this.SetField(KrConstants.Order, Int32Boxes.Box(value));
        ...
        public int GetOrder() =>
            this.TryGetField<int>(KrConstants.Order);
        ...
        public KrStageGroupBuilder SetCondition(
            string source) => this.SetField(KrConstants.SourceCondition, source);
        ...
        public KrStageGroupBuilder SetSqlCondition(
            string sql) => this.SetField(KrConstants.SqlCondition, sql);
        ...
        public KrStageGroupBuilder SetBefore(
            string source) => this.SetField(KrConstants.SourceBefore, source);
        ...
        public KrStageGroupBuilder SetAfter(
            string source) => this.SetField(KrConstants.SourceAfter, source);
        ...
        public KrStageGroupBuilder SetRuntimeCondition(
            string source) => this.SetField(KrConstants.RuntimeSourceCondition, source);
        ...
        public KrStageGroupBuilder SetRuntimeSqlCondition(
            string sql) => this.SetField(KrConstants.RuntimeSqlCondition, sql);
        ...
        public KrStageGroupBuilder SetRuntimeBefore(
            string source) => this.SetField(KrConstants.RuntimeSourceBefore, source);
        ...
        public KrStageGroupBuilder SetRuntimeAfter(
            string source) => this.SetField(KrConstants.RuntimeSourceAfter, source);
