...
namespace Tessa.Test.Default.Shared.Kr
{
    ...
    public static class KrTestHelper
    {
        ...
        {
            Check.ArgumentNotNull(mainClc, nameof(mainClc));
            Check.ArgumentNotNull(dialogCardFileContainer, nameof(dialogCardFileContainer));
            Check.ArgumentNotNull(coSettings, nameof(coSettings));
            Check.ArgumentNotNull(dialogTask, nameof(dialogTask));
