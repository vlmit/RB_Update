...
<SchemeTable Partition="dd8eeaba-9042-4fb5-9e8e-f7544463464f" ID="5640ffb9-ef7c-4584-8793-57da90e82fa0" Name="BusinessProcessInfo" Group="WorkflowEngine" InstanceType="Cards" ContentType="Entries">
	...
	<SchemePhysicalColumn ID="92d71bec-8030-49fd-bc97-1a5202c64104" Name="Assembly" Type="Binary(Max) Null">
		<Description>Сборка со скриптами тайлов. Колонка в типе карточки не должна быть добавлена, чтобы не грузить эту колонку при загрузке карточки.</Description>
	</SchemePhysicalColumn>
